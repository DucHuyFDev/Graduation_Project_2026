...
# Photo directories - define these after MEDIA_ROOT
PHOTO_DIR = BASE_DIR / 'media' / 'photo'
PHOTO_OFFICIAL_DIR = BASE_DIR / 'media' / 'photo' / 'official'
PHOTO_TMP_DIR = BASE_DIR / 'media' / 'photo' / 'tmp'

AUTH_USER_MODEL = 'accounts.User'

GEMINI_API_KEY = env('GEMINI_API_KEY')
GEMINI_MODEL = env('GEMINI_MODEL', default='gemini-2.0-flash')
PGCRYPTO_KEY = env('PGCRYPTO_KEY')
